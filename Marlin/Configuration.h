 ...
 */
#define MAX_CHAMBER_POWER 250 // limits duty cycle to chamber heater; 255=full current
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 180, 180, 22, 50 }
...
#define HOMING_FEEDRATE_MM_M { (55*60), (55*60), (18*60) }
