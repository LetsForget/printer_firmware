...
//
  ...
  #define HEATER_CHAMBER_PIN      PA15   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 18*60, 30*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
